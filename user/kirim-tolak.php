...
<body style="background: rgb(228, 224, 224);">
   ...
   <div class="sidebar close">
    ...
    <!-- kotak masuk -->
    <div><br><br>
    <h1 style="opacity: 60%;" class="text-center fw-bold mt-5 mb-5">Surat Masuk Tolak</h1>
        <div class="row">
            <div class="col-6">
                ...
                <table  class="me-3 ms-3">
                    ...
                    <tbody>
                        <?php
                                ...
                                $sql = "SELECT * FROM tolak ORDER BY id_tolak DESC";
                                $query = mysqli_query($con, $sql);
                                while($siswa = mysqli_fetch_array($query)){
                                    echo "<tr>";
                                    echo "<td>"."<img src='./image/merah.png' alt='kotak hijau' class='img-fluid mt-2'>"."</td>";
                                    echo "<td>".$siswa['jenis_surat_tolak']."</td>";
                                    echo "<td class='text-end' style='margin-right:10%;'>";
                                    echo "<a class='btn btn-primary ' href='surat-masuk-tolak.php?id=".$siswa['id_tolak']."'>Lihat</a> | ";
                                    echo "<a class='btn btn-warning ' href='proses-arsip-tolak.php?id=".$siswa['id_tolak']."'><i class='bx bx-archive-in' ></i></a> | ";
                                    echo "<a class='btn btn-danger' href='hapus.php?id=".$siswa['id_tolak']."'><i class='bx bx-trash' ></i>Hapus</a>";
                                    echo "</td>";
                                    echo "</tr>";
    
                                    echo "<tr>";
                                    echo "<td>"."</td>";
                                    echo "<td>".$siswa['tanggal_tolak']."</td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>"."<hr>"."</td>";
                                    echo "<td>"."<hr>"."</td>";
