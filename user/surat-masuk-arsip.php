<?php
                ...
                $id = $_GET['id'];
                $sql = "SELECT * FROM arsip_user WHERE id_au =$id";
                ...
                <div class="hero2 hero">
                    ...
                    <div class="row">
                        ...
                        <div class="judul" style="text-align: center">
                            <br>
                        <u><h2> <?php echo $siswa['jenis_surat_au'] ?></h2></u>
                        NOMOR:&nbsp;<?php echo $siswa['id_au'] ?> /B/FTI/2021 <br><br><br>
                        </div>
                        <div class="content">
                            <?php echo $siswa['keterangan_au'] ?><br><br><br><br>
                        </div>
                            ...
                            <tbody class="text-center">
                                ...
                                <?php
                                    ...
                                    $no5 = 5;
                                        ...
                                        echo "<td>".$no."</td>";
                                        echo "<td>".$siswa['nama_au']."</td>";
                                        echo "<td>".$siswa['nim_au']."</td>";

                                        
                                        echo "</tr>";

                                        if(!empty($siswa['nama2_au']) && !empty($siswa['nim2_au'])){
                                            echo "<tr>";
                                        
                                            echo "<td>".$no2."</td>";
                                            echo "<td>".$siswa['nama2_au']."</td>";
                                            echo "<td>".$siswa['nim2_au']."</td>";

                                            
                                            echo "</tr>";
                                        }

                                        if(!empty($siswa['nama3_au']) && !empty($siswa['nim3_au'])){
                                            echo "<tr>";
                                        
                                            echo "<td>".$no3."</td>";
                                            echo "<td>".$siswa['nama3_au']."</td>";
                                            echo "<td>".$siswa['nim3_au']."</td>";

                                            
                                            echo "</tr>";
                                        }

                                        if(!empty($siswa['nama4_au']) && !empty($siswa['nim4_au'])){
                                            echo "<tr>";
                                        
                                            echo "<td>".$no4."</td>";
                                            echo "<td>".$siswa['nama4_au']."</td>";
                                            echo "<td>".$siswa['nim4_au']."</td>";

                                            
                                            echo "</tr>";
                                        }

                                        if(!empty($siswa['nama5_au']) && !empty($siswa['nim5_au'])){
                                            echo "<tr>";
                                        
                                            echo "<td>".$no5."</td>";
                                            echo "<td>".$siswa['nama5_au']."</td>";
                                            echo "<td>".$siswa['nim5_au']."</td>";
                    ...
                    echo "<a href='cetak-arsip.php?id=".$siswa['id_au']."'><button class='btn btn-primary'>Cetak Surat</button></a>"
                    ?>
                </div>
