...
<body style="background: rgb(228, 224, 224);">
    ...
    <div class="container">
        <h1 style="text-align: center;">Draft</h1><br><br>
            <div class="hero2 hero">
                    ...
                    <tbody class="text-center">
                        ...
                        <?php
                                ...
                                $no5 = 5;
                                    ...
                                    echo "<td>".$no."</td>";
                                    echo "<td>".$siswa['nama__draft']."</td>";
                                    echo "<td>".$siswa['nim_draft']."</td>";

                                    
                                    echo "</tr>";

                                    if(!empty($siswa['nama2_draft']) && !empty($siswa['nim2_draft'])){
                                        echo "<tr>";
                                    
                                        echo "<td>".$no2."</td>";
                                        echo "<td>".$siswa['nama2_draft']."</td>";
                                        echo "<td>".$siswa['nim2_draft']."</td>";

                                        
                                        echo "</tr>";
                                    }

                                    if(!empty($siswa['nama3_draft']) && !empty($siswa['nim3_draft'])){
                                        echo "<tr>";
                                    
                                        echo "<td>".$no3."</td>";
                                        echo "<td>".$siswa['nama3_draft']."</td>";
                                        echo "<td>".$siswa['nim3_draft']."</td>";

                                        
                                        echo "</tr>";
                                    }

                                    if(!empty($siswa['nama4_draft']) && !empty($siswa['nim4_draft'])){
                                        echo "<tr>";
                                    
                                        echo "<td>".$no4."</td>";
                                        echo "<td>".$siswa['nama4_draft']."</td>";
                                        echo "<td>".$siswa['nim4_draft']."</td>";

                                        
                                        echo "</tr>";
                                    }

                                    if(!empty($siswa['nama5_draft']) && !empty($siswa['nim5_draft'])){
                                        echo "<tr>";
                                    
                                        echo "<td>".$no5."</td>";
                                        echo "<td>".$siswa['nama5_draft']."</td>";
                                        echo "<td>".$siswa['nim5_draft']."</td>";
                ...
                <?php
                echo "<a href='cetak-draft.php?id=".$siswa['id_draft']."'><button class='btn btn-primary'>Cetak Surat</button></a>"
                ?>
                </div>
