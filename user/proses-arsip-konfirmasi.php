            ...
            <div class="hero2 hero">
                ...
                <div class="row">
                    ...
                    <div class="judul" style="text-align: center">
                        <br>
                    <u name="judul"><h2> <?php echo $siswa['jenis_surat_konfirmasi'] ?></h2></u>
                ...
                <div class="text-end">
                    ...
                    <input type="hidden" name="id" placeholder="72190345" value="<?php echo $siswa['id_konfirmasi'] ?>" class="form-control">
                    <input type="hidden" name="input_nim" placeholder="72190345" value="<?php echo $siswa['nim_konfirmasi'] ?>" class="form-control">
                    <input type="hidden" name="input_nama" placeholder="Joey Sapakoly" value="<?php echo $siswa['nama_konfirmasi'] ?>" class="form-control" >
                    <input type="hidden" name="input_nim2" placeholder="72190345" value="<?php echo $siswa['nim2_konfirmasi'] ?>" class="form-control" >
                    <input type="hidden" name="input_nama2" placeholder="Joey Sapakoly" value="<?php echo $siswa['nama2_konfirmasi'] ?>" class="form-control">
                    <input type="hidden" name="input_nim3" placeholder="72190345" value="<?php echo $siswa['nim3_konfirmasi'] ?>" class="form-control" >
                    <input type="hidden" name="input_nama3" placeholder="Joey Sapakoly" value="<?php echo $siswa['nama3_konfirmasi'] ?>" class="form-control">
                    <input type="hidden" name="input_nim4" placeholder="72190345" value="<?php echo $siswa['nim4_konfirmasi'] ?>" class="form-control" >
                    <input type="hidden" name="input_nama4" placeholder="Joey Sapakoly" value="<?php echo $siswa['nama4_konfirmasi'] ?>" class="form-control">
                    <input type="hidden" name="input_nim5" placeholder="72190345" value="<?php echo $siswa['nim5_konfirmasi'] ?>" class="form-control" >
                    <input type="hidden" name="input_nama5" placeholder="Joey Sapakoly" value="<?php echo $siswa['nama5_konfirmasi'] ?>" class="form-control">
                    <input type="hidden" name="input_email" placeholder="iniemailsaya@fti.ukdw.ac.id" value="<?php echo $siswa['email_konfirmasi'] ?>" class="form-control" >
                    <input type="hidden" name="input_telp" placeholder="0812 3456 7789" value="<?php echo $siswa['telpon_konfirmasi'] ?>" class="form-control">

                    <select style="display:none;" name="jensu" class="form-control " placeholder="Pilih Jeis Surat">
                        <option><?php echo $siswa['jenis_surat_konfirmasi'] ?></option>
                    </select>
                    ...
                    <input style="display:none;" class="form-control" type="date" value="<?php echo $siswa['tanggal_konfirmasi'] ?>" name="tanggal" >
                    <input type="hidden" name="tujuan" placeholder="Tujuan" value="<?php echo $siswa['tujuan_konfirmasi'] ?>" class="form-control"> 
                    <input type="hidden" name="nama_mitra" placeholder="Nama Mitra" value="<?php echo $siswa['nama_mitra_konfirmasi'] ?>" class="form-control"> 
                    <input type="hidden" name="alamat_mitra" placeholder="Alamat Mitra" value="<?php echo $siswa['alamat_mitra_konfirmasi'] ?>" class="form-control">
                    <input name="keterangan" type="hidden" value="<?php echo $siswa['keterangan_konfirmasi'] ?>" class="form-control" >
