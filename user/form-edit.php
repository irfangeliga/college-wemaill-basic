...
$sql = "SELECT * FROM draft WHERE id_draft = '$id'";
        ...
        <form action="proses-pengajuan.php" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-5">
                    ...
                    <input type="text" name="input_nim" placeholder="72190345" value="<?php echo $siswa['nim_draft'] ?>" class="form-control" >
                    <span class="peringatan">*Nim tidak dapat diubah</span>
                </div>

                <div class="col-7" >
                    Nama Mahasiswa <br>
                    <input type="text" name="input_nama" placeholder="Joey Sapakoly" value="<?php echo $siswa['nama__draft'] ?>" class="form-control" value="<?php  ?>">
            ...
            <div class="row">
                <div class="col-5">
                    ...
                    NIM Mahasiswa 2 <br>
                    <input type="text" name="input_nim2" placeholder="72190345" value="<?php echo $siswa['nim2_draft'] ?>" class="form-control" >
                    <span class="peringatan">*bila ada</span><br><br>
                </div>

                <div class="col-7" >
                    <br>  Nama Mahasiswa 2 <br>
                    <input type="text" name="input_nama2" placeholder="Joey Sapakoly" value="<?php echo $siswa['nama2_draft'] ?>" class="form-control">
            ...
            <div class="row">
                <div class="col-5">
                    NIM Mahasiswa 3 <br>
                    <input type="text" name="input_nim3" placeholder="72190345" value="<?php echo $siswa['nim3_draft'] ?>" class="form-control" >
                    <span class="peringatan">*bila ada</span><br><br>
                </div>

                <div class="col-7" >
                    Nama Mahasiswa 3 <br>
                    <input type="text" name="input_nama3" placeholder="Joey Sapakoly" value="<?php echo $siswa['nama3_draft'] ?>" class="form-control">
                    <span class="peringatan">*bila ada</span><br><br><br>
                </div>
            ...
            <div class="row">
                <div class="col-5">
                    NIM Mahasiswa 4 <br>
                    <input type="text" name="input_nim4" placeholder="72190345" value="<?php echo $siswa['nim4_draft'] ?>" class="form-control" >
                    <span class="peringatan">*bila ada</span><br><br>
                </div>

                <div class="col-7" >
                    Nama Mahasiswa 4 <br>
                    <input type="text" name="input_nama4" placeholder="Joey Sapakoly" value="<?php echo $siswa['nama4_draft'] ?>" class="form-control">
                    <span class="peringatan">*bila ada</span><br><br><br>
                </div>
            ...
            <div class="row">
                <div class="col-5">
                    NIM Mahasiswa 5 <br>
                    <input type="text" name="input_nim5" placeholder="72190345" value="<?php echo $siswa['nim5_draft'] ?>" class="form-control" >
                    <span class="peringatan">*bila ada</span><br><br>
                </div>

                <div class="col-7" >
                    Nama Mahasiswa 5 <br>
                    <input type="text" name="input_nama5" placeholder="Joey Sapakoly" value="<?php echo $siswa['nama5_draft'] ?>" class="form-control">
                    <span class="peringatan">*bila ada</span><br><br><br>
                </div>
                ...
                <div class="row">
                    ...
                    <label for="jensu">Pilih Jenis Surat</label>
                        ...
                        <select name="jensu" class="form-control " placeholder="Pilih Jeis Surat">
                            ...
                            <option <?php echo ($jensu == 'Permohonan Surat Izin KP - A') ? "selected": ""  ?>>Permohonan Surat Izin KP - A</option>
                            <option <?php echo ($jensu == 'Surat Keterangan - B') ? "selected": ""  ?>>Surat Keterangan - B</option>
                            <option <?php echo ($jensu == 'Surat Permohonan Keringanan Spp - B') ? "selected": ""  ?>>Surat Permohonan Keringanan Spp - B</option>
                            <option <?php echo ($jensu == 'Surat Permohonan Beasiswa - B') ? "selected": ""  ?>>Surat Permohonan Beasiswa - B</option>
                            <option <?php echo ($jensu == 'Surat Keterangan - B') ? "selected": ""  ?>>Surat Keterangan - B</option>
                        </select>
                    </div>
                    <div class="col-6">
                ...
                <div class="row-cols-1">
                    Tujuan Surat <br>
                <input type="text" name="tujuan" placeholder="Tujuan" class="form-control" value="<?php echo $siswa['tujuan_draft'] ?>"> <br><br>
                
                Nama Mitra <br>
                <input type="text" name="nama_mitra" placeholder="Nama Mitra" class="form-control" value="<?php echo $siswa['nama_mitra_draft'] ?>" > <br><br>

                Alamat Mitra <br>
                <input type="text" name="alamat_mitra" placeholder="Alamat Mitra" class="form-control" value="<?php echo $siswa['alamat_mitra_draft'] ?>"><br><br>
