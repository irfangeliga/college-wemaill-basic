...
<body style="background: rgb(228, 224, 224);">
    ...
    <h1 style="opacity: 60%;" class="text-center fw-bold mt-5 mb-5">Arsip</h1>
        ...
        <div  class="container hero2">
            ...
            <div class="row">
                    ...
                    <thead>
                        ...
                        <?php
                            ...
                            include("../koneksi.php");
                            $sql = "SELECT * FROM arsip_dosen ORDER BY id_ad DESC";
                            $query = mysqli_query($con, $sql);
                            while($siswa = mysqli_fetch_array($query)){
                                echo "<tr>";
                                echo "<td>".$siswa['jenis_surat_ad']."</td>";
                                echo "<td class='text-end' style='margin-right:10%;'>";
                                echo "<a class='btn btn50 btn-primary ' href='surat-masuk-arsip.php?id=".$siswa['id_ad']."'>Lihat</a> | ";
                                echo "<a class='btn btn50 btn-danger' href='hapus-arsip.php?id=".$siswa['id_ad']."'><i class='bx bx-trash' ></i>Hapus</a>";
                                echo "</td>";
                                echo "</tr>";

                                echo "<tr>";
                                echo "<td>".$siswa['tanggal_ad']."</td>";
                                echo "</tr>";
                                echo "<tr>";
                                echo "<td>"."<hr>"."</td>";
                                echo "<td>"."<hr>"."</td>";
            ...
            <a class="btn btn-primary " style="margin-left: 75%;" href="buat-surat-dosen.php">Buat Surat</a><br><br>
        </div><br><br>
    </div>
