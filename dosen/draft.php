...
<body style="background: rgb(228, 224, 224);">
   ...
   <div class="sidebar close">
    ...
    <!-- kotak masuk -->
    <div><br><br>
        <h1 style="opacity: 60%;" class="text-center fw-bold mt-5 mb-5">Draft</h1>
        ...
        <div class="row">
                    ...
                    <tbody>
                        <?php
                           include('../koneksi.php');
                            ...
                            $sql = "SELECT * FROM draft_dosen ORDER BY id_draft DESC";
                            $query = mysqli_query($con, $sql);
                            while($siswa = mysqli_fetch_array($query)){
                                echo "<tr>";
                                echo "<td>".$siswa['jenis_surat_draft']."</td>";
                                echo "<td class='text-end' style='margin-right:10%;'>";
                                echo "<a class='btn btn-primary ' href='lihat-draft.php?id=".$siswa['id_draft']."'>Lihat</a> | ";
                                echo "<a class='btn btn-primary ' href='form-edit.php?id=".$siswa['id_draft']."'>Edit</a> | ";
                                echo "<a class='btn btn-danger' href='hapus-draft.php?id=".$siswa['id_draft']."'><i class='bx bx-trash' ></i>Hapus</a>";
                                echo "</td>";
                                echo "</tr>";

                                echo "<tr>";
                                echo "<td>".$siswa['tanggal_draft']."</td>";
                                echo "</tr>";
                                echo "<tr>";
                                echo "<td>"."<hr>"."</td>";
                                echo "<td>"."<hr>"."</td>";
            ...
            <a class="btn btn-primary " style="margin-left: 84%;" href="buat-surat-dosen.php">Buat Surat</a><br><br>
        </div>
