<?php
    ...
    $sql = "SELECT * FROM arsip_dosen WHERE id_ad =$id";
            ...
            <div class="hero2 hero">
                ...
                <div class="row">
                    ...
                    <div class="judul" style="text-align: center">
                        <br>
                    <u><h2> <?php echo $siswa['jenis_surat_ad'] ?></h2></u>
                    NOMOR:&nbsp;<?php echo $siswa['id_ad'] ?> /B/FTI/2021 <br><br><br>
                    </div>
                    <div class="content">
                    <?php echo $siswa['keterangan_ad'] ?><br><br><br><br>
                    </div>
                    ...
                    <tbody class="text-center">
                        ...
                        <?php
                                ...
                                $no5 = 5;
                                    ...
                                    echo "<td>".$no."</td>";
                                    echo "<td>".$siswa['nama_ad']."</td>";
                                    echo "<td>".$siswa['nik_ad']."</td>";
                                    echo "</tr>";
                ...
                if(!empty($siswa['pejabat'])){
                    ...
                    echo "<a href='cetak-arsip.php?id=".$siswa['id_ad']."'><button class='btn btn-primary'>Cetak Surat</button></a>";
                ?>
                </div>
