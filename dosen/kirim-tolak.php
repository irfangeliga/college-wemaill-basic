                ...
                <table  class="me-3 ms-3">
                    ...
                    <tbody>
                        <?php
                                ...
                                $sql = "SELECT * FROM reject ORDER BY id_td DESC";
                                $query = mysqli_query($con, $sql);
                                while($siswa = mysqli_fetch_array($query)){
                                    echo "<tr>";
                                    echo "<td>"."<img src='./image/merah.png' alt='kotak hijau' class='img-fluid mt-2'>"."</td>";
                                    echo "<td>".$siswa['jenis_surat_td']."</td>";
                                    echo "<td class='text-end' style='margin-right:10%;'>";
                                    echo "<a class='btn btn-primary ' href='surat-masuk-tolak.php?id=".$siswa['id_td']."'>Lihat</a> | ";
                                    echo "<a class='btn btn-warning ' href='proses-arsip-tolak.php?id=".$siswa['id_td']."'><i class='bx bx-archive-in' ></i></a> | ";
                                    echo "<a class='btn btn-danger' href='hapus.php?id=".$siswa['id_td']."'><i class='bx bx-trash' ></i>Hapus</a>";
                                    echo "</td>";
                                    echo "</tr>";
    
                                    echo "<tr>";
                                    echo "<td>"."</td>";
                                    echo "<td>".$siswa['tanggal_td']."</td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>"."<hr>"."</td>";
                                    echo "<td>"."<hr>"."</td>";
