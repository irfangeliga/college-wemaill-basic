...
<body style="background: rgb(228, 224, 224);">
    ...
    <div class="halaman">
    <h1 style="text-align: center;">Arsip Pengajuan Mahasiswa</h1>
        <div class="container">
            <ul class="nav me-auto mb-2 mb-lg-0">
                <li class="nav-item active">
                  <a class="nav-link active" aria-current="page" href="arsip-admin.php">Mahasiswa</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="arsip-admin-dosen.php" data-toggle="tab">Dosen</a>
                </li>
        </ul><br>
        ...
        <div class="hero hero2 tab-pane" id="mahasiswa">
                    ...
                    <tbody>
                        <?php
                            ...
                            $sql = "SELECT * FROM arsip_admin_user ORDER BY id_aau DESC";
                            $query = mysqli_query($con, $sql);
                            while($siswa = mysqli_fetch_array($query)){
                                echo "<tr>";

                                echo "<td>".$siswa['jenis_surat_aau']."</td>";
                                echo "<td class='text-end' >";
                                echo "<a class='btn btn-primary ' href='lihat-arsip-user.php?id=".$siswa['id_aau']."'>Lihat</a> | ";
                                echo "<a class='btn btn-danger' href='hapus-arsip-user.php?id=".$siswa['id_aau']."'><i class='bx bx-trash' ></i>Hapus</a>";
                                echo "</td>";
                                echo "</tr>";

                                echo "<tr>";
                                echo "<td>".$siswa['tanggal_aau']."</td>";
                                echo "</tr>";
                                echo "<tr>";
                                echo "<td>"."<hr>"."</td>";
                                echo "<td>"."<hr>"."</td>";
