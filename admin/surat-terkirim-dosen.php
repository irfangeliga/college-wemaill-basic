...
<body style="background: rgb(228, 224, 224);">
    ...
    <br>
    <div class="halaman">
    <h1 style="text-align: center;">Surat Terkirim Dosen</h1>
        <div class="container">
            ...
            <div class="hero hero2 tab-pane" id="mahasiswa">
                    ...
                    <tbody>
                        <?php
                            ...
                            $sql = "SELECT * FROM notifikasi_dosen ORDER BY id_pd DESC";
                            ...
                            while($siswa = mysqli_fetch_array($query)){
                                ...
                                echo "<a class='btn btn-primary ' href='lihat-notifikasi-dosen.php?id=".$siswa['id_pd']."'>Lihat</a> | ";
                                echo "<a class='btn btn-danger' href='hapus-notifikasi-dosen.php?id=".$siswa['id_pd']."'><i class='bx bx-trash' ></i>Hapus</a>";
                                echo "</td>";
                                echo "</tr>";
