...
<body style="background: rgb(228, 224, 224);">
    ...
    <div class="halaman">
    <h1 style="text-align: center;">Arsip Pengajuan Dosen</h1>
        <div class="container">
        ...
        <div class="hero hero2 tab-pane" id="mahasiswa">
                    ...
                    <tbody>
                        <?php
                                ...
                                $sql = "SELECT * FROM arsip_admin_dosen ORDER BY id_aad DESC";
                                $query = mysqli_query($con, $sql);
                                while($siswa = mysqli_fetch_array($query)){
                                    echo "<tr>";
    
                                    echo "<td>".$siswa['jenis_surat_aad']."</td>";
                                    echo "<td class='text-end' >";
                                    echo "<a class='btn btn-primary ' href='lihat-arsip-user2.php?id=".$siswa['id_aad']."'>Lihat</a> | ";
                                    echo "<a class='btn btn-danger' href='hapus-arsip-dosen.php?id=".$siswa['id_aad']."'><i class='bx bx-trash' ></i>Hapus</a>";
                                    echo "</td>";
                                    echo "</tr>";
    
                                    echo "<tr>";
                                    echo "<td>".$siswa['tanggal_aad']."</td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>"."<hr>"."</td>";
                                    echo "<td>"."<hr>"."</td>";
