...
<body style="background: rgb(228, 224, 224);">
    ...
    <br>
    <div class="halaman">
    <h1 style="text-align: center;">Pengajuan Mahasiswa</h1>
        <div class="container">
            ...
            <table  class="me-5 ms-5">
                    ...
                    <tbody>
                        <?php
                            ...
                            while($siswa = mysqli_fetch_array($query)){
                                ...
                                echo "<a class='btn btn-primary ' href='menijau.php?id=".$siswa['id']."'>Tinjau</a> | ";
                                echo "<a class='btn btn-warning ' href='lihat-arsip-mhs.php?id=".$siswa['id']."'><i class='bx bx-archive-in' ></i></a> | ";
                                echo "<a class='btn btn-primary' href='hapus.php?id=".$siswa['id']."'><i class='bx bx-trash' ></i>Hapus</a>";
                                echo "</td>";
                                echo "</tr>";
                ...
                <a class="btn btn1" href="buat-surat.php" style="color: white;">Buat Surat</a>
                <br><br>
            </div>
        </div>
    </div>
