...
<body style="background: rgb(228, 224, 224);">
    ...
    <br>
    <div class="halaman">
        <h1 style="text-align: center;">Pengajuan Dosen</h1>
            <div class="container">
                <ul class="nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item active">
                    <a class="nav-link active" aria-current="page" href="pengajuan-mhs.php">Mahasiswa</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="pengajuan-dosen.php" data-toggle="tab">Dosen</a>
                    </li>
            ...
            <div class="hero hero2 tab-pane" id="mahasiswa">
                    ...
                    <tbody>
                        <?php
                            ...
                            $sql = "SELECT * FROM pengajuan_dosen ORDER BY id_pd DESC";
                            $query = mysqli_query($con, $sql);
                            while($siswa = mysqli_fetch_array($query)){
                                echo "<tr>";

                                echo "<td>".$siswa['jenis_surat_pd']."</td>";
                                echo "<td class='text-end' style='margin-right:10%;'>";
                                echo "<a class='btn btn-primary ' href='menijau-dosen.php?id=".$siswa['id_pd']."'>Tinjau</a> | ";
                                echo "<a class='btn btn-warning ' href='lihat-arsip-dosen.php?id=".$siswa['id_pd']."'><i class='bx bx-archive-in' ></i></a> | ";
                                echo "<a class='btn btn-primary' href='hapus-dosen.php?id=".$siswa['id_pd']."'><i class='bx bx-trash' ></i>Hapus</a>";
                                echo "</td>";
                                echo "</tr>";

                                echo "<tr>";
                                echo "<td>".$siswa['tanggal_pd']."</td>";
                                echo "</tr>";
                                echo "<tr>";
                                echo "<td>"."<hr>"."</td>";
                                echo "<td>"."<hr>"."</td>";
