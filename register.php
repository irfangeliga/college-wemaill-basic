...
if( isset($_POST['submit']) ){
        ...
        if(!empty(trim($name)) && !empty(trim($username)) && !empty(trim($email)) && !empty(trim($password)) && !empty(trim($repass)) && !empty(trim($status)) ){
            ...
            if($password == $repass){
                ...
                if( cek_nama($name,$con) == 0 ){
                    ...
                    $query = "INSERT INTO users (username,nama,email, password, status ) VALUES ('$username','$name','$email','$pass', '$status')";
...
<body>
        <section class="container-fluid mb-5">
            ...
            <section class="col-12 col-sm-6 col-md-4">
                <form class="form-container mb-5" action="register.php" method="POST">
